...
if not sta.isconnected():
    ...
    sta.active(True)
    sta.connect('~~', 'inub7056')  # Replace with your WiFi SSID and password
...
def web_page():
    ...
    <html>  
        ...
        <body>  
          ...
          <center>
           <img src="https://th.bing.com/th/id/OIG.bxu5iRZYQ_eqj_7BDv10?pid=ImgGn" alt="Happy pets" style="width: 70%;">
           <form>  
